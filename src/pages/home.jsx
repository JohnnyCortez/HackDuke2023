      ...
      return (
        ...
        {currentImageIndex === 2 ? (
          <img
            ...
            style={{ width: '60%', border: '4px solid #45503b', filter: 'brightness(0.5)' }} // Adjust the width as needed
          />
        ) : currentImageIndex === 0 ? (
            <img
            src={images[currentImageIndex]}
            alt={`Image ${currentImageIndex + 1}`}
            style={{ width: '60%', border: '4px solid #45503b', marginTop: '30px', filter: 'brightness(0.5)' }} // Adjust the width as needed
          />
        ) : currentImageIndex === 1 ? (
          <img
          src={images[currentImageIndex]}
